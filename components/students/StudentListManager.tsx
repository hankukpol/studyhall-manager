    ...
    <>
      <div className="space-y-6">
        ...
        <section className="rounded-[30px] border border-slate-200-black/5 bg-white p-5 shadow-[0_18px_44px_rgba(18,32,56,0.06)]">
          ...
          <div className="mt-5 flex flex-wrap items-center justify-between gap-3 rounded-[24px] border border-slate-200-slate-200 bg-white px-4 py-3">
          ...
          <div className="mt-6 hidden overflow-hidden rounded-[24px] border border-slate-200-slate-200 lg:block">
          ...
          <div className="mt-5 space-y-3 lg:hidden">
            {filteredStudents.map((student) => (
              <article key={student.id} className="rounded-[24px] border border-slate-200-slate-200 bg-white p-4">
          ...
          {filteredStudents.length === 0 ? (
            <div className="mt-6 rounded-[24px] border border-slate-200-dashed border-slate-300 bg-white px-5 py-10 text-center">
