    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[0.4fr_0.6fr]">
        <section className="space-y-6">
          <article className="rounded-[30px] border border-slate-200-black/5 bg-white p-6 shadow-[0_18px_48px_rgba(18,32,56,0.07)]">
                ...
                <div className="space-y-4">
                  ...
                  {selectedSeat ? (
                    <>
                      ...
                      <label className="block">
                        <span className="mb-2 block text-sm font-medium text-slate-700">학생 배정 / 좌석 이동</span>
                        <select
                      ...
                      {selectedAssignedStudent ? (
                        <div className="rounded-[24px] border border-slate-200-slate-200 bg-white p-4">
                          ...
                          <p className="mt-2 text-sm text-slate-600">
                            수험번호 {selectedAssignedStudent.studentNumber}
                          </p>
                          <p className="mt-1 text-sm text-slate-600">
                            현재 상태 {getStudentStatusLabel(selectedAssignedStudent.status)}
                          </p>
                        </div>
                      ) : null}
                      ...
                      <label className="flex items-center justify-between rounded-2xl border border-slate-200-slate-200 bg-white px-4 py-3">
                        <span>
                          ...
                          <span className="block text-xs text-slate-500">
                            비활성 좌석은 좌석도에만 보이고 배정 대상에서는 제외됩니다.
                          </span>
                        </span>
                        <input
                          type="checkbox"
